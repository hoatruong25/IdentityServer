...
public class Config
{
    ...
    public static IEnumerable<ApiResource> ApiResources =>
        new[]
        {
            ...
            {
                Scopes = new List<string> { "CoffeeAPI.read", "CoffeeAPI.write" }, // Feature ?
                ApiSecrets = new List<Secret> { new Secret("ScopeSecret".Sha256()) },
                UserClaims = new List<string> { "role" } // Feature ?
            }
        };
    ...
    public static IEnumerable<Client> Clients => new[]
    {
        ...
        // interactive client using code flow + pkce //Using Open Connect
        new Client
        {
